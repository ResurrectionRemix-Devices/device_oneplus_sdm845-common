...
package org.resurrection.device.DeviceSettings;
...
public class FPSTileService extends TileService {
  ...
  public void onStartListening() {
      ...
      for (ActivityManager.RunningServiceInfo service :
          ...
          if (org.resurrection.device.DeviceSettings.FPSInfoService.class.getName().equals(
  ...
  @Override
  public void onClick() {
      Intent fpsinfo = new Intent(this, org.resurrection.device.DeviceSettings.FPSInfoService.class);
      if (!isShowing)
